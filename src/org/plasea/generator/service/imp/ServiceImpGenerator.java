...
public class ServiceImpGenerator {
	...
	public static void generateServiceBase(GenerateInfo generateInfo,Table table){
        ...
        try {  
            cfg.setClassForTemplateLoading(ModelGenerator.class, "/org/plasea/generator/service/imp");//指定模板所在的classpath目录  
            cfg.setSharedVariable("upperFC", new UpperFirstCharacter());//添加一个"宏"共享变量用来将属性名首字母大写  
            Template t = cfg.getTemplate("service-imp.html");//指定模板  
