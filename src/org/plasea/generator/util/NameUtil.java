...
import org.plasea.generator.database.oracle.OracleTableField;
...
public class NameUtil {
	...
	public static String dealName(String originalName){
		...
		if(originalName.contains("_")){
			...
			newName = originalName.toLowerCase();
		}
		return newName;
	...
	public static OracleTableField dealOracleTable(OracleTableField originalField){
		OracleTableField resultField = originalField;
		resultField.setField(dealName(resultField.getColumnName()));
		resultField.setType(getJavaType(resultField.getType()));
		return resultField;
	}
